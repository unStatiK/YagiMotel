...
public class ReplayUrlHelperTest {
    ...
    public void testExtractUrl() {
        ...
        Assert.assertEquals(hash, ReplayUrlHelper.extractHash(cnPaipuUrl));
        Assert.assertEquals(hash, ReplayUrlHelper.extractHash(globalPaipuUrl));
        Assert.assertEquals(hash, ReplayUrlHelper.extractHash(jpPaipuUrl));
    }
    ...
    public void testExtractUrlInOtherCases() {
        ...
        Assert.assertEquals(hash, ReplayUrlHelper.extractHash(url));
